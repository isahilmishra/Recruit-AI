 ...
 * `prisma.user`: Exposes CRUD operations for the **User** model.
  ...
  */
    ...
    /**
     * `prisma.candidateEvaluation`: Exposes CRUD operations for the **CandidateEvaluation** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more CandidateEvaluations
      * const candidateEvaluations = await prisma.candidateEvaluation.findMany()
      * ```
      */
    get candidateEvaluation(): Prisma.CandidateEvaluationDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
