...
import { generateEmail, semanticSearchCandidates } from '../utils/ai';
...
export class RecruiterController {
    ...
    static async getJobCreationStatus(req, res, next) {
        try {
    ...
    static async searchCandidates(req, res, next) {
        try {
            ...
            const enrichedResults = searchResult.matches.map((match) => {
            ...
            }).filter((r) => r.id); // Filter out any undefined matches just in case
